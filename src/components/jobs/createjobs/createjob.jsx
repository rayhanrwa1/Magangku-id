...
import JobProvinceSelect from './jobprovinceselect'; // sesuaikan path dengan struktur foldermu
				...
				<div className="flex-1 flex flex-col min-w-0">
					...
					<main className="p-4 md:p-6 lg:p-8">
						<div className="bg-white border border-red-200 rounded-lg p-6 md:p-8 text-center max-w-2xl mx-auto">
							...
							<p className="text-gray-600 mb-6">Anda belum dapat membuat lowongan pekerjaan sebelum akun mitra diverifikasi oleh admin. Mohon tunggu proses verifikasi.</p>
			...
			<div className="flex-1 flex flex-col min-w-0">
				...
				<main className="p-4 md:p-6 lg:p-8 space-y-6">
					...
					<div>
						...
						<p className="text-sm text-gray-600 mt-1">Lengkapi detail lowongan pekerjaan untuk dipublish</p>
					</div>
					...
					<div className="bg-white rounded-lg border border-gray-200">
						<div className="bg-slate-800 px-6 py-4 border-b border-gray-200">
							...
							<p className="text-slate-300 text-sm mt-0.5">Detail posisi yang tersedia</p>
						</div>
