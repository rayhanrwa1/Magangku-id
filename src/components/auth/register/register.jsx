        ...
        <div className="flex flex-1 flex-col md:flex-row items-center px-4 md:px-8 justify-center gap-6 md:gap-8 w-full">
          ...
          <div className="w-full md:w-1/2 flex justify-center max-w-md">
            <img
              ...
              className="rounded-xl object-cover w-full h-[220px] md:h-[400px]"
            />
          </div>

          {/* Form Register */}
          <div className="w-full md:w-1/2 max-w-lg bg-white rounded-xl shadow-lg px-5 md:px-10 py-7 md:py-10">
