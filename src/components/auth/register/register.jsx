					...
					<div className="w-full max-w-lg">
						<div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-10 space-y-8">
							...
							<div className="space-y-2">
								<h1 className="text-4xl font-semibold text-gray-900">Daftar Mitra</h1>
								<p className="text-gray-500 text-lg">Bergabunglah dengan ribuan mitra kami</p>
							</div>
							...
							<div className="space-y-5">
									...
									<div className="relative">
										...
										<input
											...
											className={`w-full pl-12 pr-4 py-3 text-base rounded-lg border ${
												errors.email ? 'border-red-300 focus:border-red-400 focus:ring-red-100' : 'border-gray-300 focus:border-gray-400 focus:ring-gray-100'
									...
									<div className="relative">
										...
										<input
											...
											className={`w-full pl-12 pr-14 py-3 text-base rounded-lg border ${
												errors.password ? 'border-red-300 focus:border-red-400 focus:ring-red-100' : 'border-gray-300 focus:border-gray-400 focus:ring-gray-100'
											} focus:outline-none focus:ring-4 transition-all bg-white text-gray-900 placeholder-gray-400`}
											placeholder="••••••••"
										/>
										<button
								...
								{/* Confirm Password */}
								<div className="space-y-2">
									<label className="text-base font-medium text-gray-700">Konfirmasi Password</label>
									<div className="relative">
										<Lock className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
										<input
											...
											onChange={handleChange}
											className={`w-full pl-12 pr-14 py-3 text-base rounded-lg border ${
												errors.confirm_password ? 'border-red-300 focus:border-red-400 focus:ring-red-100' : 'border-gray-300 focus:border-gray-400 focus:ring-gray-100'
											} focus:outline-none focus:ring-4 transition-all bg-white text-gray-900 placeholder-gray-400`}
											placeholder="••••••••"
										/>
										<button
								...
								{/* Tipe Pengguna */}
								<div className="space-y-2">
									<label className="text-base font-medium text-gray-700">Tipe Pengguna</label>
