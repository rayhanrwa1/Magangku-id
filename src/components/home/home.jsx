	...
	return (
		<div className="min-h-screen flex bg-slate-50">
			...
			<div className="flex-1 flex flex-col">
				<Navbar
					mitraPhoto={mitraData?.photo || 'Foto belum ditambahkan'}
				...
				<main className="p-4 space-y-4">
					{!mitraData && !loading && (
						<div className="flex items-center justify-between p-4 bg-red-50 border border-red-200 rounded-lg">
							...
							<div className="flex items-start gap-3">
								...
								<div>
									<p className="text-red-800 font-medium">Profil Mitra Belum Dibuat</p>
									<p className="text-red-700 text-sm">
										Silakan lengkapi <span className="font-semibold">Profile Mitra </span>
										untuk melanjutkan proses verifikasi dan menggunakan dashboard.
									</p>
								</div>
							</div>
					...
					{userData?.verified === false && (
						<div className="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
							...
							/>
							<div>
								<p className="text-yellow-800 font-medium">Akun Anda belum diverifikasi</p>
								<p className="text-yellow-700 text-sm">Tunggu persetujuan admin atau lengkapi Profile Mitra jika belum lengkap.</p>
							</div>
						</div>
					)}
				</main>
